...
const allRecipes: Recipe[] = [
  ...
  },
  {
    ...
    category: 'cocktails',
    isCocktail: true,
    image: 'classic-margarita',
    description: 'A timeless and refreshing cocktail with tequila, lime juice, and a hint of orange liqueur.',
    calories: 180,
    protein: 0,
    carbs: 15,
    fat: 0,
    ...
    instructions: [
      ...
      'Add tequila, lime juice, orange liqueur, and agave syrup to the shaker.',
